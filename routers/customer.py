...
from schema.customer import Customer, CustomerCreate, CustomerUpdate, customers
...
def create_customer(payload: CustomerCreate = Depends(customer_service.check_existing_username)):
...
def edit_customer(customer_id: int, payload: CustomerUpdate):
    curr_customer = None
    # get the customer
